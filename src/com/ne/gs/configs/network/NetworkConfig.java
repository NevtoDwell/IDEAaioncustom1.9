 ...
 */
package com.ne.gs.configs.network;
...
public final class NetworkConfig {
    ...
    /**
     * Number of Threads dedicated to be doing io read & write. There is always 1 acceptor thread. If value is < 1 - acceptor thread will also handle read &
     * write. If value is > 0 - there will be given amount of read & write threads + 1 acceptor thread.
     */
    ...
    @Property(key = "gameserver.network.log.cp", defaultValue = "false")
    public static boolean LOG_CLIENT_PCK;

    @Property(key = "gameserver.network.log.sp", defaultValue = "false")
    public static boolean LOG_SERVER_PCK;
