...
public class IDFactory {
    ...
    private IDFactory() {
        ...
        lockIds(GDB.get(PlayerDAO.class).getUsedIDs());
        lockIds(GDB.get(InventoryDAO.class).getUsedIDs());
        lockIds(GDB.get(LegionDAO.class).getUsedIDs());
        lockIds(GDB.get(MailDAO.class).getUsedIDs());
        lockIds(HTMLService.getUsedIDs());
        lockIds(Housing.getUsedIDs());
