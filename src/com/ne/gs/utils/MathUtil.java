...
public final class MathUtil {
     ...
     * @return boolean
     */
    public static boolean isIn3dRange(float obj1X, float obj1Y, float obj1Z, float obj2X, float obj2Y, float obj2Z,
            float range) {
     ...
     * @return float
     */
    public static float convertHeadingToDegree(int clientHeading) {
    ...
    public static boolean isNearCoordinates(VisibleObject obj, float x, float y, float z, int offset) {
        return getDistance(obj.getX(), obj.getY(), obj.getZ(), x, y, z) < offset + MOVE_CHECK_OFFSET;
    }
    ...
    public static boolean isNearCoordinates(VisibleObject obj, VisibleObject obj2, int offset) {
        return getDistance(obj.getX(), obj.getY(), obj.getZ(), obj2.getX(), obj2.getY(), obj2.getZ()) < offset + MOVE_CHECK_OFFSET;
    }
    ...
    public static boolean isInsideAttackCylinder(VisibleObject obj1, VisibleObject obj2, int length, int radius,
            boolean isFront) {
    ...
    public static void TreadPool(final Player player) {
        ThreadPoolManager.getInstance().schedule(new Runnable() {
            @Override
            public void run() {
                Coordinates c = player.getCoordinates();
                player.getMoveController().setNewDirection(c.getX(), c.getY(), c.getZ());
                World.getInstance().updatePosition(player, c.getX(), c.getY(), c.getZ(), player.getHeading());
