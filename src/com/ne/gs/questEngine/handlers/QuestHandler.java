        ...
        if (qs.getQuestVarById(varNum) == step) {
            ...
            final ItemUseObserver observer = new ItemUseObserver() {
                ...
                public void abort() {
                    ...
                    player.sendPck(SM_SYSTEM_MESSAGE.STR_ITEM_CANCELED(DescId.of(item.getItemTemplate().getNameId())));
                    PacketSendUtility.broadcastPacket(player, new SM_ITEM_USAGE_ANIMATION(player.getObjectId(), item.getObjectId(), item
