...
import com.ne.gs.network.factories.LsPacketHandlerFactory;
...
public class LoginServerConnection extends AConnection {
    ...
    /**
     * Its guaranted that closePacket will be sent before closing connection, but all past and future packets wont. Connection will be closed [by Dispatcher
