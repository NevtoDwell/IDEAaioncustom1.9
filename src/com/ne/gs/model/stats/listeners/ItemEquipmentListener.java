...
import com.ne.gs.model.templates.itemset.FullBonus;
import com.ne.gs.model.templates.itemset.ItemSetTemplate;
import com.ne.gs.model.templates.itemset.PartBonus;
import com.ne.gs.services.EnchantService;

/**
 * @author xavier modified by Wakizashi
 */
public final class ItemEquipmentListener {
    ...
    private static void onItemEquipment(Item item, CreatureGameStats<?> cgs) {
        ...
        if (slot == ItemSlot.MAIN_HAND.id() || slot == ItemSlot.SUB_HAND.id()) {
            ...
            if (item.hasFusionedItem()) {
                ...
                if (weaponStats != null) {
                    ...
                    }else if (fusionedItemTemplate.getWeaponType() == WeaponType.STAFF_2H) {
