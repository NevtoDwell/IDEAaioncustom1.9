...
public class RectangleArea extends AbstractArea {
     ...
     *     maximal z
     */
    public RectangleArea(ZoneName zoneName, int worldId, Point p1, Point p2, Point p3, Point p4, int minZ,
                         int maxZ) {
    ...
    /*
     * (non-Javadoc)
     * @see com.ne.gs.model.geometry.Area#intersectsRectangle(com.ne.gs.model.geometry.RectangleArea)
     */
    @Override
