...
public class WalkerGroup {
     ...
     *     - point of next move
     * @param shift
     *     - distance from origin located in lines perpendicular to destination; for SagittalShift if negative then located to the left from origin,
     *     otherwise, to the right for CoronalShift if negative then located to back, otherwise to the front
     *
